        ...
        <Container maxWidth="md" sx={{ mt: 4, mb: 4 }}>
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 1 }}>
                    Please provide detailed responses to the following questions. Based on your responses, we will
                    predict your Personality Type and recommend you Movies and Books you will definitely love!
                </Typography>
                <Alert color="info" sx={{ mb: 2 }}>
                    <AlertTitle>Completing this step is Mandatory</AlertTitle>
                    Completing this form is a mandatory step before we prepare a customised dashboard just for you.
                    Please try to be as yourself as possible while answering.
                </Alert>
